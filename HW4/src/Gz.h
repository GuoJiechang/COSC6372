...
private:
	...
	//Function for convert vertex to view space
	GzVertex fromObjectToView(GzVertex& v);
	//Function for convert normal to view space
	GzVector fromObjectToView(GzVector& n);
//============================================================================
